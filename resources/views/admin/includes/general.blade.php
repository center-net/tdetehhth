   ...
   <div class="sidebar">
      ...
      <nav class="mt-2">
         ...
         {{-- @endif --}}
            ...
            <li class="nav-item has-treeview {{ (request()->is('admin/invoicesddddddddddddddddddd*'))?'menu-open':'' }}">
            ...
            <li class="nav-item has-treeview  {{ (request()->is('admin/invoices*'))?'menu-open':'' }} ">
               ...
               <ul class="nav nav-treeview">
                  <li class="nav-item">
                     <a href="{{ route('admin.BillingCategories') }}" class="nav-link {{ (request()->is('admin/invoices/BillingCategories*') )?'active':'' }}">
                        *
                        <p>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('admin.ItemCategories') }}" class="nav-link {{ (request()->is('admin/invoices/ItemCategories*') )?'active':'' }}">
                        *
                        <p>
                           فئات الاصناف         
                        </p>
            ...
            <li class="nav-item has-treeview {{ ( request()->is('admin/admins_accounts*') || request()->is('admin/permission_roles*')  || request()->is('admin/permission_main_menues*') ||request()->is('admin/permission_sub_menues*'))?'menu-open':'' }}     ">
               ...
               <ul class="nav nav-treeview">
                  <li class="nav-item">
                     ...
                     <a href="#" class="nav-link {{ (request()->is('admin/permission_roles*') )?'active':'' }}">
                        <p>
                           أدوار المستخدمين         
                        </p>
                     </a>
                     ...
                     <a href="#" class="nav-link {{ (request()->is('admin/permission_main_menues*') )?'active':'' }}">
                        <p>
                    القوائم الرئيسية للصلاحيات        
                        </p>
                     </a>
                     <a href="#" class="nav-link {{ (request()->is('admin/permission_sub_menues*') )?'active':'' }}">
                        <p>
